...
\addbibresource{Multi-Cloud.bib}
...
\begin{document}
    ...
    \section{Research Questions} 
        \input{sections/research questions.tex}
    
    \section{Theoretical Background}
        \input{sections/theoretical_background.tex}
    
    \section{Research Methodology}
        \input{sections/research_methodology.tex}
    
    \section{Significance and Relevance}
        \input{sections/significance_and_relevance.tex}
